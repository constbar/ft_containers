...
namespace diy {
	...
	class map {
		...
		public:
			...
			typedef typename diy::pair<const key_type, mapped_type> value_type;
	...
	public:
		...
		// typedef typename ft::bidit<value_type, value_type *, value_type &> iterator;
		...
		map()//const key_compare comp = key_compare(),
			...
			// const Nalloc &nalloc = Nalloc()) 
			{
				diy::rbtree<T> kek;
				tree = kek;
			}
		
		// tree(rbtree<T>(value_compare(comp), alloc, nalloc)) {}

// 		template <class InputIterator>
// 		map(InputIterator first, InputIterator last, const key_compare &comp = key_compare(), const allocator_type &alloc = allocator_type(),
// 			typename ft::enable_if<ft::is_input_iterator_tag<typename InputIterator::iterator_category>::value>::type * = NULL) : _tree(RBTree<value_type, value_compare, allocator_type>(value_compare(comp), alloc))
// 		{
// 			insert(first, last);
// 		}

// 		map(const map &x) : _tree(RBTree<value_type, value_compare, allocator_type>(value_compare(Compare()), Alloc()))
// 		{
